...
if __name__ == "__main__":
    ...
    flags.DEFINE_string("record_tag", None, "Tf record tag for different data source")
    ...
    flags.DEFINE_boolean("use_intensity", True, "Whether to use intensity feature")
    flags.DEFINE_boolean("use_constant", False, "Whether to use constant feature")
    tf.app.run()
